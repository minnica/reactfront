      ...
      <div className="container mt-5">
        ...
        <div className="row">
          <div className="col-md-12 d-flex justify-content-center">
            <div className="card-custom text-bg-light mb-3 shadow p-3 mb-5 bg-body-tertiary rounded">
              <div className="card-body">
                <h2 className="card-title text-center">$73,143.85</h2>
                <div className="row d-flex justify-content-center text-center mt-3 mb-3">
                ...
                <div className="card-text">
                  <div className="row">
                    ...
                    <div className="col-4">
                      <span className="fw-bold text-secondary">Ingresos</span>{' '}
                      <br />
                    ...
                    <div className="col-4">
                      <span className="fw-bold text-secondary">Gastos</span>{' '}
                      <br />
